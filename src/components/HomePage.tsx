...
export const HomePage: React.FC<HomePageProps> = ({ onNavigate, onLogin, isAdmin, profile, user, onSecretClick }) => {
      ...
      <div className="flex flex-col gap-4 items-center">
        {!user && (
          <motion.button
            ...
            animate={{ opacity: 1 }}
            onClick={onLogin}
            className="flex items-center gap-2 bg-white text-gray-900 px-6 py-2 rounded-full font-bold hover:bg-gray-100 transition-all shadow-lg"
          >
