    ...
    <div className="min-h-screen bg-gray-950 text-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Official results updated periodically (every 2 hours)</p>
        ...
        <div className="space-y-6">
          {data.results.map((c, i) => (
            ...
            >
              ...
              <img src={c.logoUrl} alt={c.name} className="w-12 h-12 object-contain bg-white rounded-lg p-1" referrerPolicy="no-referrer" />
